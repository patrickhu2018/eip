<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="item_user_setting.aspx.cs" Inherits="item_user_setting" MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="write_Box" style="flex: 0 0 100%;">
            ...
            <div class="write_textBox">
                <div class="d-flex justify-content-between" style="width: 100%">
                    ...
                    <%--<div id="src1" class="dataBox row" style="width: 100%;">
                        <!-- 組室欄位 -->
                        ...
                        <!-- 狀態欄位 -->
                        <div class="col-12 col-lg-6 formItem title6" style="flex-wrap: wrap; margin-left: 0px;">
                            <div class="ItemTitle"><span>管理權限狀態</span></div>
                            <div class="ItemContent">
                                <div class="row">
                ...
                <ContentTemplate>
                    <asp:GridView ID="gv" runat="server" class="table table-bordered mt-2" AutoGenerateColumns="False" OnRowCommand="gv_RowCommand" DataSourceID="SqlDataSource1"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText='管理權限狀態<span class="fa fa-caret-down"/>' ItemStyle-HorizontalAlign="center" ItemStyle-Width="1%" SortExpression="specil_show_page">
                                <ItemTemplate>
                                    <asp:Label ID="state" runat="server" Text='<%# Eval("specil_show_page") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
