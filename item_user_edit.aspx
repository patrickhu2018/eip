<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="item_user_edit.aspx.cs" Inherits="item_user_edit" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        var m = url.get('m');
        if (m !== "0") {
            document.getElementById("people_05").classList.add("active");
            document.getElementById("people_04").classList.remove("active");
        }
    </script>
    <div class="write_Box">
        ...
        <div class="write_textBox">
            ...
            <div class="dataBox row" style="width: 120%;">
                <div class="col-4  col-lg-3 col-xl-3 formItem title6">
                ...
                <div class="col-4  col-lg-3 col-xl-3 formItem title4">
            ...
            <div class="dataBox row" style="width: 180%;">
                <div class="col-2 formItem title6">
                    ...
                    <div class="ItemContent">
                        <asp:TextBox ID="job" runat="server" CssClass="form-control" Style="width: 150px;" Enabled="false"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="dataBox row" style="width: 180%;">
                                         ...
                                         <ContentTemplate>
                                             <table class="table1" style="width:100%;">
                                                 ...
                                                 <tr runat="server" ID="RightSettingTr3" class="tb-bg">
                                                     ...
                                                     <td>
                                                         <div style="display:inline-flex;">【我的申請】、【清單查詢】、【品名及科目管理】</div>
                                                     </td>
                                                 </tr>
                                                     ...
                                                     <td>
                                                         <div style="display:flex;justify-content:center;">
                                                             <asp:DropDownList runat="server" Enabled="false" ID="JobSettingDDL1_1" CssClass="form-control DDLwidth">
                                                                 ...
                                                                 <asp:ListItem Value="2">清單查詢</asp:ListItem>
                                                                 <asp:ListItem Value="3">品名及科目管理</asp:ListItem>
                                                                 <asp:ListItem Value="4">使用者設定</asp:ListItem>
                                                             </asp:DropDownList>
                                                         </div>
                                                     </td>
                                                     <td>
