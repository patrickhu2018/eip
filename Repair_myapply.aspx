<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Repair_myapply.aspx.cs" Inherits="Repair_myapply" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="write_Box" style="margin-right: 4rem; width: 100%">
            ...
            <div class="write_textBox">
                ...
                <div class="dataBox row" style="display: flex; align-items: center;">
                    <div id="src1" class="col-6 col-lg-8 col-xl-4 formItem title3" style="margin-right: 1.5em; width: 100%">
                        <div class="ItemTitle"><span>處理狀況</span></div>
                        <div class="ItemContent" style="display: flex; align-items: center;">
                            <div class="row" style="width: auto">
                                <div style="margin-left: 15px;">
                                    <asp:CheckBox runat="server" ID="chk1" Style="margin-right: 5px;" Checked="true" /><span>待處理</span>
                                    <asp:CheckBox runat="server" ID="chk2" Style="margin-right: 5px; margin-left: 5px;" Checked="true" /><span>處理中</span>
                                    <asp:CheckBox runat="server" ID="chk3" Style="margin-right: 5px; margin-left: 5px;" Visible="false" /><%--<span>已完成</span>--%>
                                    <asp:CheckBox runat="server" ID="chk4" Style="margin-right: 5px; margin-left: 5px;" Visible="false" /><%--<span>退件</span>--%>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div style="display: flex; align-items: center; flex-wrap: wrap;">
                        <div class="col-12 formItem title3">
                            ...
                            <div class="ItemContent" style="display: flex; align-items: center; flex-wrap: wrap;">
                                ...
                                <asp:RadioButton ID="rb_lastMonth" runat="server" GroupName="applyDate" Text="近一個月" Checked="true" Style="margin-right: 5px; margin-left: 0px;" AutoPostBack="true" OnCheckedChanged="rb_SelectedIndexChanged" />
    ...
    <div class="write_Box" style="width: 100%">
        <div class="write_Title" style="padding-bottom: 0.5em">
            <h5>
                <asp:Literal runat="server" ID="Literal1">查詢結果</asp:Literal></h5>

            <div style="color: #000; float: right; font-size: 0.875rem; margin-top: 5px;">*尚未完成處理案件可在此查詢，如需查詢已完成或退件請至修繕申請查詢</div>
        </div>
        <div class="write_textBox">
            <asp:GridView ID="gv" runat="server" class="table table-bordered mt-2" AutoGenerateColumns="False" OnRowCommand="gv_RowCommand" OnRowDataBound="gv_RowDataBound"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText='事由<span class="fa fa-caret-down"/>' ItemStyle-HorizontalAlign="center" ItemStyle-Width="3%" SortExpression="apply_reason">
                        <ItemTemplate>
