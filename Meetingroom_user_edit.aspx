<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage3.master" AutoEventWireup="true" CodeFile="Meetingroom_user_edit.aspx.cs" Inherits="Meetingroom_user_edit" MaintainScrollPositionOnPostback="true"%>
...
if (m !== "0") {
    ...
    document.getElementById("people_06").classList.remove("active");
}
</script>
<div class="write_Box">
        ...
        <div class="dataBox row" style="width: 80%;">
            <div class="col-3 formItem title6">
                ...
                <div class="ItemContent">
                    <asp:DropDownList ID="group" runat="server" CssClass="form-control" Style="width: 130%" Enabled="false">
                            ...
                            <ContentTemplate>
                                <table class="table1" style="width:100%;">
                                    ...
                                    <tr runat="server" ID="RightSettingTr3" class="tb-bg">
                                        ...
                                        <td>
                                            <div style="display:inline-flex;">【會議室使用狀況】、【會議室詳情】</div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div style="display:flex;justify-content:center;">
                                                <asp:DropDownList runat="server" Enabled="false" ID="JobSettingDDL1_1" CssClass="form-control DDLwidth">
                                                    <asp:ListItem Value="1" Selected="True">會議室使用狀況</asp:ListItem>
                                                    <asp:ListItem Value="2">會議室詳情</asp:ListItem>
                                                    <asp:ListItem Value="3">使用者設定</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                        <td>
