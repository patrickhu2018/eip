<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Repair_user_setting.aspx.cs" Inherits="Repair_user_setting" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="write_Box" style="flex: 0 0 100%;">
            ...
            <div class="write_textBox">
                <div class="d-flex justify-content-between" style="width: 100%">
                    <asp:UpdatePanel ID="UpdatePanel1" class="dataBox row" style="width: 100%; display: contents;" runat="server">
                        <ContentTemplate>
                            <table style="margin-right: 15px;">
                                <tr>
                                    <td style="width: 100px; font-weight: bold;">組室</td>
                                    <td style="width: 200px;">
                                        <asp:DropDownList runat="server" ID="group" CssClass="form-control" Style=""
                    ...
                    <%--<div class="dataBox row" style="width: 100%;">
                        <!-- 組室欄位 -->
                        <div class="col-6 col-lg-5 formItem title6" style="margin-right: 30px;">
                            <div class="ItemTitle"><span>組室</span></div>
                            <div class="ItemContent">
                                <asp:DropDownList ID="group" runat="server" CssClass="form-control" Style="width: 100%">
                        ...
                        <!-- 狀態欄位 -->
                        <div class="col-12 col-lg-6 formItem title2" style="flex-wrap: wrap; margin-left: 0px;">
                ...
                <table style="margin-top: 15px">
                    ...
                    <tr style="">
                        ...
                        <td style="">
                            <asp:TextBox ID="keyword" runat="server" CssClass="form-control" Style="width: 185%;height: 35px;" placeholder="請輸入使用者、帳號或職位來做查詢"></asp:TextBox>
                        </td>
                    </tr>--%>
                    <tr>
                        <td style="width:100px;font-weight: bold;">狀態</td>
    ...
    <div class="write_Box">
        <div class="write_Title"style="display: flex; padding-bottom: 8px; align-items: center; height: 64px; justify-content:space-between;">
        ...
        <div class="write_textBox">
            <asp:GridView ID="gv" runat="server" class="table table-bordered mt-2" AutoGenerateColumns="False" OnRowCommand="gv_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText='組室<span class="fa fa-caret-down"/>' ItemStyle-HorizontalAlign="center" ItemStyle-Width="1%" SortExpression="user_group">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText='管理權限狀態<span class="fa fa-caret-down"/>' ItemStyle-HorizontalAlign="center" ItemStyle-Width="1%" SortExpression="repair_show_page">
                        <ItemTemplate>
                            <asp:Label ID="state" runat="server" Text='<%# Eval("repair_show_page") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
